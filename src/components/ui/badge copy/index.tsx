...
export default function BadgeComponentCopy({
  ...
  const handleTouchMove = (e: TouchEvent) => {
    if (isDragging) {
      ...
      setPosition((prev) => {
        const newX = prev.x + deltaX / 4; // Ambil rata-rata antara posisi sebelumnya dan delta
        const newY = prev.y + deltaY / 4; // Ambil rata-rata antara posisi sebelumnya dan delta
        setDragStart({ x: touch.clientX, y: touch.clientY });
